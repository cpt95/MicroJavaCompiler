...
public class ClassVarList extends ClassVarDeclList {

    private ClassError ClassError;
    private ClassVarDeclList ClassVarDeclList;

    public ClassVarList (ClassError ClassError, ClassVarDeclList ClassVarDeclList) {
