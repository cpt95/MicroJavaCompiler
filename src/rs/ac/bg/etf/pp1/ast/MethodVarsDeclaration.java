...
public class MethodVarsDeclaration extends MethodVar {

    private Type Type;
    private MethodVarDeclList MethodVarDeclList;

    public MethodVarsDeclaration (Type Type, MethodVarDeclList MethodVarDeclList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarsDeclaration(\n");
